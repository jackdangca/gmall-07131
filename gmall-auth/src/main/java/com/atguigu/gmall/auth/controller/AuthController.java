...
public class AuthController {
    ...
    public String login(
            ...
            @RequestParam(value = "loginName",defaultValue = "http://www.gmall.com")String loginName,
            @RequestParam(value = "password",defaultValue = "http://www.gmall.com")String password,
